...
#include <linux/fb.h>
#include <mxsfb.h>
extern int  tda19988_init(void);
extern void tda19988_reset(void);
...
static iomux_v3_cfg_t const usdhc2_pads[] = {
	...
	/* CD pin */    
    MX6SX_PAD_SD1_DATA0__GPIO6_IO_2 | MUX_PAD_CTRL(NO_PAD_CTRL),
    /* Power */
    MX6SX_PAD_SD1_CMD__GPIO6_IO_1 | MUX_PAD_CTRL(NO_PAD_CTRL),
};
...
void board_late_mmc_init(void)
{
	...
	/* Set mmcblk env */
	sprintf(mmcblk, "/dev/mmcblk%dp2 rootwait rootfstype=ext4 rw ",
...
static iomux_v3_cfg_t const lvds_ctrl_pads[] = {
    ...
    /* Enable */
	MX6SX_PAD_QSPI1B_DATA3__GPIO4_IO_27 | MUX_PAD_CTRL(NO_PAD_CTRL),
